...
int main()
{
	...
	// chunked test
	// std::string test = "GET /index.html HTTP/1.1\r\nHost: github.co.kr:2000\r\nContent-Length: 30\r\nTransfer-Encoding: gzip, chunked\r\nCookie: session_id=abc123; user_id=12345\r\nConnection: keep-alive\r\nUser-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36\r\nAccept: image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8\r\nReferer: http://github.co.kr/\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7\r\n\r\nB\r\nLorem ipsum\r\n10B\r\ndolor sit amet, consectetur adipiscing elit. Suspendisse aliquet urna eu mi faucibus, nec eleifend est lobortis. Fusce pulvinar massa metus, sed eleifend nisl venenatis vitae. Aliquam vel elit quis nulla dapibus lacinia. Fusce sed erat vel tellus tristique fringilla.\r\n0\r\n\r\n";
